...
[VolumeComponentMenu("Post-processing Custom/HurtPostProcessing")]

// If the related Scriptable Renderer Feature doesn't exist, display a warning about adding it to the renderer.
[VolumeRequiresRendererFeatures(typeof(HurtPostProcessingRendererFeature))]
...
public sealed class HurtPostProcessingVolumeComponent : VolumeComponent, IPostProcessComponent
{
    // Set the name of the volume component in the list in the Volume Profile.
    public HurtPostProcessingVolumeComponent()
    {
        displayName = "HurtPostProcessing";
    }
