...
public sealed class HurtPostProcessingRendererFeature : ScriptableRendererFeature
{
    ...
    public override void AddRenderPasses(ScriptableRenderer renderer, ref RenderingData renderingData)
    {
        ...
        HurtPostProcessingVolumeComponent myVolume = VolumeManager.instance.stack?.GetComponent<HurtPostProcessingVolumeComponent>();
