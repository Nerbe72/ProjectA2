...
public class TableDialogue : TableBase
{
    [Serializable]
    public class Info
    {
    ...
    protected bool Read(CSVReader _Reader, Info _Info, int _Row, int _Col)
    {
        ...
        _Reader.get(_Row, ref _Info.TalkID);
        _Reader.get(_Row, ref _Info.CameraAction);
        _Reader.get(_Row, ref _Info.NPCAction);
        _Reader.get(_Row, ref _Info.PlayerAction);
        _Reader.get(_Row, ref _Info.NextID);
        _Reader.get(_Row, ref _Info.Choice);
        _Reader.get(_Row, ref _Info.OpenWindow);
